...
function WineCard({ wines, setWines, user, setUser }) {
    ...
    function updateWinesAndUser(newReview) {
            ...
            <div className="row g-0" width={100}>
              <div className="col-md-4" width={100}>
                <img
                  ...
                  alt="..."
                  style={{ maxHeight: "25rems" }}
                />
              </div>
              <div className="col-md-8">
                <div className="card-body">
                  <h4 className="card-title">
                    {wine.maker} - {wine.bottle_name}
                  </h4>
                  ...
                  <p className="card-text">
                    <small>Category: {wine.category}</small>
                  </p>
                  ...
                  <p className="card-text">
                    ...
                    <Button
                      ...
                      size="sm"
                      style={{ margin: "15px", color: "#800022" }}
                    >
                      Leave a Review
                    </Button>
                  </p>
